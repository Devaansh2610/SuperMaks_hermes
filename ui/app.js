...
let WAKE_SONG = {source:'off', url:'', local_ready:false, seconds:105,
                 volume:0.35, duck:0.10};
let wakeSongAudio = null, wakeSongTimer = null;
...
function mockFetch(url, opts = {}){
  ...
  if (url === '/api/status') return json({
    ...
    model:'Hermes default', tools:['terminal','browser','files','google_workspace','memory','mcp:notion','mcp:github'],
